...
def write_slice_bat_file():
    ...
    filepath = "C:\Users\\articulab.rae\Desktop\RAPT_WoZ_Videos\\" ## Change to your local filepath where the video file folder is
    participant = ["P1", "P2", "P3"]  ## Change these to the start of the video file names
